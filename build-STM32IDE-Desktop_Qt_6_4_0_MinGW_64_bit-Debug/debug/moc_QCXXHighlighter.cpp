...
#include <memory>
#include "../../STM32IDE/QCodeEditor/include/internal/QCXXHighlighter.hpp"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_QCXXHighlighter_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_QCXXHighlighter_t qt_meta_stringdata_QCXXHighlighter = {
    {
        QT_MOC_LITERAL(0, 15)   // "QCXXHighlighter"
    },
    "QCXXHighlighter"
};
...
Q_CONSTINIT static const uint qt_meta_data_QCXXHighlighter[] = {
...
Q_CONSTINIT const QMetaObject QCXXHighlighter::staticMetaObject = { {
    QMetaObject::SuperData::link<QStyleSyntaxHighlighter::staticMetaObject>(),
    qt_meta_stringdata_QCXXHighlighter.offsetsAndSizes,
    qt_meta_data_QCXXHighlighter,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_QCXXHighlighter_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QCXXHighlighter, std::true_type>
    >,
    nullptr
} };
